...
--
  ...
  -- NUM_THREADS = 20						-- originally 20
  -- WAIT_TIME = 10							-- originally 10
  -- NUMBER_ITERATIONS = 20					-- originally 20
  -- WAIT_TIME2 = 5							-- originally 5
  -- NUMBER_ITERATIONS_2 = 5                -- origianlly 5 -- WTF _2?
  -- MAX_NUMBER_OF_PROCESSES = 10			-- originally 10
  -- NUMBER_OF_PHYSICAL_PAGE_FRAMES = 27	-- originally 27
  -- MAX_PAGES_PER_VIRT_SPACE = 20			-- originally 20
  --
  ...
  function RunFrameManagerTests ()
      ...
      for i = 1 to MAX_NUMBER_OF_PROCESSES
		...
		printInt (i)
		print (" of ")
		printInt (MAX_NUMBER_OF_PROCESSES)
		print ("\n")
        -------------------------------------
		...
		print (" of ")
		printInt (MAX_NUMBER_OF_PROCESSES)
		print (" forked --- end of this thread's for loop iteration\n")
		-------------------------------------
      endFor

	  print ("DEBUG - done with for loop (for i = 1 to MAX_NUMBER_OF_PROCESSES)\n ")
	  print ("\tIn RunFrameManagerTests")
	  print ("\tAlthough the forked threads will probably be still running\n")
	  
	  print ("\n\nDEBUG - Before for loop executing AllDone2.Down()\n ")
  ...
  function TestFrameManager (myID: int)
     var i, j, newData, sz: int
      ...
      for i = 1 to NUMBER_ITERATIONS_2
		...
		-------------------------------------
		print (": DEBUG - TestFrameManager OUTER FOR LOOP - i = ")
		printInt (i)

		print (" of ")
		printInt (MAX_NUMBER_OF_PROCESSES)
		print (" (NUMBER_ITERATIONS_2)\n")
        -------------------------------------
        ...
        for sz = 1 to MAX_PAGES_PER_VIRT_SPACE-1
		  ...
		  print ("\nDEBUG: TestFrameManager - Before frameManager. ReturnAllFrames (&pcb.addrSpace)\n")
